...
public class DAORepositoryMock implements IDAORepository{
    ...
    public List<Repository> loadRepositories(String nameFile) {
        ...
        if (true) {
            ...
            repositories.add(new Repository("2", "2", "bla^3", "", "https://github.com/tomlongo/Flickable.js.git", 321));
            repositories.add(new Repository("3", "456", "bla^3", "", "https://github.com/emergingstack/es-dev-stack.git", 321));
